...
import smallImg from '../assets/мелкая.png'
import riverImg from '../assets/речная.png'
import seaImg from '../assets/морская.png'
import squidImg from '../assets/кальмар.png'
import royalImg from '../assets/королевская.png'
    ...
    <div class="content">
      ...
      <div v-else class="fish-list">
        <div v-for="(fish, index) in fishInventory" class="fish-item"
          ...
          <img class="fish-icon" :src="typeIcons[fish.type]" :alt="fish.species || fish.type" />
